...
> **مهم — تغطية الاختبارات:** عند البدء بأي عمل على تغطية الاختبارات/رفعها إلى 90%، اقرأ أولاً وبشكل كامل `docs/COVERAGE_PROMPT.md` (دليل المهام والدفعات). لا تبدأ قبل قراءته.
