...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("super_admin", "school_admin", "teacher", "student", "parent", name="user_role"),
            nullable=False,
        ),
        ...
        sa.Column(
            "approval_status", sa.Enum("pending", "approved", "rejected", name="user_approval_status"), nullable=False
        ),
